Contributing to BoldTechnologyCommerceUganda blockchain
============================

The BoldTechnologyCommerceUganda blockchain project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to BoldTechnologyCommerceUganda-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the BoldTechnologyCommerceUganda blockchainunit tests or QA tests
...
[Translation Process](https://github.com/Bold-Technology-Commerce-Uganda/BTCUG/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BoldTechnologyCommerceUganda blockchain project, and is not to be
confused with overall BoldTechnologyCommerceUganda Network Protocol consensus changes.

Whether a pull request is merged into BoldTechnologyCommerceUganda blockchain rests with the project merge
...
Patches that change BoldTechnologyCommerceUganda consensus rules are considerably more involved than
...
Where a patchset proposes to change the BoldTechnologyCommerceUganda consensus, it must have been
...
The project leader is the release manager for each BoldTechnologyCommerceUganda blockchain release.
