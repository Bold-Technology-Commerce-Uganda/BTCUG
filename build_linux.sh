...
# Create zip file of binaries
	cp BoldTechnologyCommerceUganda/src/BoldTechnologyCommerceUgandad BoldTechnologyCommerceUganda/src/BoldTechnologyCommerceUganda-cli BoldTechnologyCommerceUganda/src/BoldTechnologyCommerceUganda-tx BoldTechnologyCommerceUganda/src/qt/BoldTechnologyCommerceUganda-qt .
	zip BoldTechnologyCommerceUganda-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip BoldTechnologyCommerceUgandad BoldTechnologyCommerceUganda-cli BoldTechnologyCommerceUganda-tx BoldTechnologyCommerceUganda-qt
	rm -f BoldTechnologyCommerceUgandad BoldTechnologyCommerceUganda-cli BoldTechnologyCommerceUganda-tx BoldTechnologyCommerceUganda-qt
