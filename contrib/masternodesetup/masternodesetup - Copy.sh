...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='BoldTechnologyCommerceUganda.conf'
CONFIGFOLDER='/root/.BoldTechnologyCommerceUganda'
COIN_DAEMON='BoldTechnologyCommerceUgandad'
COIN_CLI='BoldTechnologyCommerceUganda-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Bold-Technology-Commerce-Uganda/BTCUG/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='BoldTechnologyCommerceUganda'
COIN_PORT=10033
RPC_PORT=10032
