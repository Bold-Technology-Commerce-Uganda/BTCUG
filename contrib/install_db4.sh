...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the BoldTechnologyCommerceUganda repository."
  exit 1
fi
...
echo
echo 'When compiling BoldTechnologyCommerceUgandad, run `./configure` in the following way:'
echo
