...
# Create zip file of binaries
	cp $PROJECT_ROOT/src/BoldTechnologyCommerceUgandad.exe $PROJECT_ROOT/src/BoldTechnologyCommerceUganda-cli.exe $PROJECT_ROOT/src/BoldTechnologyCommerceUganda-tx.exe $PROJECT_ROOT/src/qt/BoldTechnologyCommerceUganda-qt.exe .
	zip BoldTechnologyCommerceUganda-Windows.zip BoldTechnologyCommerceUgandad.exe BoldTechnologyCommerceUganda-cli.exe BoldTechnologyCommerceUganda-tx.exe BoldTechnologyCommerceUganda-qt.exe
	rm -f BoldTechnologyCommerceUgandad.exe BoldTechnologyCommerceUganda-cli.exe BoldTechnologyCommerceUganda-tx.exe BoldTechnologyCommerceUganda-qt.exe
