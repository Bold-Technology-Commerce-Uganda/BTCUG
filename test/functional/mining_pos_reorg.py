...
class ReorgStakeTest(BoldTechnologyCommerceUgandaTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected BoldTechnologyCommerceUganda supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check BoldTechnologyCommerceUganda supply at the beginning
        # ------------------------------------------
        # BoldTechnologyCommerceUganda supply: block rewards minus burned fees for minting
        ...
        # Verify that BoldTechnologyCommerceUganda supplies were properly updated after the spends and reorgs
        self.log.info("Check BoldTechnologyCommerceUganda supply...")
