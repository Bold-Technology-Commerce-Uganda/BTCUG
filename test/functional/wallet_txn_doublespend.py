...
class TxnMallTest(BoldTechnologyCommerceUgandaTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 6,250 BoldTechnologyCommerceUganda:
        ...
        # First: use raw transaction API to send 1240 * 5 BoldTechnologyCommerceUganda to node1_address,
        # but don't broadcast:
