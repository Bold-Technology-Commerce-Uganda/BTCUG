...
- 1) start one BoldTechnologyCommerceUgandad node from an pre-HD wallet wallet.dat file localized in util/data
...
class WalletUpgradeTest (BoldTechnologyCommerceUgandaTestFramework):
