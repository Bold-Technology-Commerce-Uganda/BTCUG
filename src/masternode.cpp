...
{
    if (nHeight >  4993200) return    85000 * COIN;
    if (nHeight >  4730400) return    80000 * COIN;
    if (nHeight >  4467600) return    75000 * COIN;
    if (nHeight >  4204800) return    70000 * COIN;
    if (nHeight >  3942000) return    65000 * COIN;
    if (nHeight >  3679200) return    60000 * COIN;
    if (nHeight >  3416400) return    55000 * COIN;
    if (nHeight >  3153600) return    50000 * COIN;
    if (nHeight >  2890800) return    45000 * COIN;
    if (nHeight >  2628000) return    40000 * COIN;
    if (nHeight >  2365200) return    35000 * COIN;
    if (nHeight >  2102400) return    30000 * COIN;
    if (nHeight >  1839600) return    25000 * COIN;
    if (nHeight >  1576800) return    20000 * COIN;
    if (nHeight >  1314000) return    15000 * COIN;
    if (nHeight >  1051200) return    12500 * COIN;
    if (nHeight >  788400)  return    10000 * COIN;
    if (nHeight >  525600)  return    8000 * COIN;
    if (nHeight >  262800)  return    6000 * COIN;
    if (nHeight >  50000)   return    4000 * COIN;
...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 1) {
        ...
        nSubsidy = 0.7159664 * COIN;
    }
    else if (nHeight <= 262800) {
        nSubsidy = 0.78756304 * COIN;
    }
    else if (nHeight <= 525600) {
        nSubsidy = 0.866319344 * COIN;
    }
    else if (nHeight <= 788400) {
        nSubsidy = 0.952951278 * COIN;
    }
    else if (nHeight <= 1051200) { 
        nSubsidy = 1.048246406 * COIN;
    }
    else if (nHeight <= 1314000) { 
        nSubsidy = 1.153071047 * COIN;
    }
    else if (nHeight <= 1576800) { 
        nSubsidy = 1.268378152 * COIN;
    }
    else if (nHeight <= 1839600) { 
        nSubsidy = 1.395215967 * COIN;
    }
    else if (nHeight <= 2102400) { 
        nSubsidy = 1.534737563 * COIN;
    }
    else if (nHeight <= 2365200) { 
        nSubsidy = 1.68821132 * COIN;
    }
    else if (nHeight <= 2628000) { 
        nSubsidy = 1.857032452 * COIN;
    }
    else if (nHeight <= 2890800) { 
        nSubsidy = 2.042735697 * COIN;
    }
    else if (nHeight <= 3153600) { 
        nSubsidy = 2.247009267 * COIN;
    }
    else if (nHeight <= 3416400) { 
        nSubsidy = 2.471710193 * COIN;
    }
    else if (nHeight <= 3679200) { 
        nSubsidy = 2.718881213 * COIN;
    }
    else if (nHeight <= 3942000) { 
        nSubsidy = 2.990769334 * COIN;
    }
    else if (nHeight <= 4204800) { 
        nSubsidy = 3.289846267 * COIN;
    }
    else if (nHeight <= 4467600) { 
        nSubsidy = 3.618830894 * COIN;
    }
    else if (nHeight <= 4730400) { 
        nSubsidy = 3.980713983 * COIN;
    }
    else if (nHeight <= 4993200) { 
        nSubsidy = 4.378785382 * COIN;
    }
    else if (nHeight <= 5255858) { 
        nSubsidy = 4.81666392 * COIN;
    }
    else if (nHeight == 5255859) { 
        nSubsidy = 3.92255979 * COIN;
    }
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 BoldTechnologyCommerceUganda tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 BoldTechnologyCommerceUganda tx -> 1 confirmation
