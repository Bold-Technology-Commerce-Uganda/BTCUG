...
public:
    ...
    /** 
     * Amount of BoldTechnologyCommerceUganda coming in to a transaction
...
// BoldTechnologyCommerceUganda: It assumes that overwrites are never possible due to BIP34 always in effect
