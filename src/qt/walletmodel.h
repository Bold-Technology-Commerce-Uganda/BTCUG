...
#ifndef BOLDTECHNOLOGYCOMMERCEUGANDA_QT_WALLETMODEL_H
#define BOLDTECHNOLOGYCOMMERCEUGANDA_QT_WALLETMODEL_H
...
/** Interface to BTCUG wallet from Qt view code. */
...
#endif // BOLDTECHNOLOGYCOMMERCEUGANDA_QT_WALLETMODEL_H
