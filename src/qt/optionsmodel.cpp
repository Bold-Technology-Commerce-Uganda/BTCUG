...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeBoldTechnologyCommerceUgandaAmount") || reset)
        SoftSetArg("-anonymizeBoldTechnologyCommerceUgandaamount", settings.value("nAnonymizeBoldTechnologyCommerceUgandaAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in BoldTechnologyCommerceUganda.cpp during shotdown to also remove the window positions
