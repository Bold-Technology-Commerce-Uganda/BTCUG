...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            BOLDTECHNOLOGYCOMMERCEUGANDAGUI* window = static_cast<BOLDTECHNOLOGYCOMMERCEUGANDAGUI*>(parentWidget());
...
{
    BOLDTECHNOLOGYCOMMERCEUGANDAGUI* gui = static_cast<BOLDTECHNOLOGYCOMMERCEUGANDAGUI*>(parentWidget());
...
{
    hide();
    static_cast<BOLDTECHNOLOGYCOMMERCEUGANDAGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BTCUG will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BTCUGs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
