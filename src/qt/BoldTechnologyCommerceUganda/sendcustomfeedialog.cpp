...
#include "qt/BoldTechnologyCommerceUganda/sendcustomfeedialog.h"
#include "qt/BoldTechnologyCommerceUganda/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &BOLDTECHNOLOGYCOMMERCEUGANDAGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
