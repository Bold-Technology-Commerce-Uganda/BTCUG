...
#include "qt/BoldTechnologyCommerceUganda/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("BoldTechnologyCommerceUganda_tx_csv_export(*.csv)") : tr("BTCUG_addresses_csv_export(*.csv)"),
                                        nullptr);
