...
#include "qt/BoldTechnologyCommerceUganda/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/BoldTechnologyCommerceUganda/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window, QWidget *parent) :
