...
#include "qt/BoldTechnologyCommerceUganda/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/BoldTechnologyCommerceUganda/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window, QWidget *parent) :
