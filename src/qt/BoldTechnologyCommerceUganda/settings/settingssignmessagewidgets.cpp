...
#include "qt/BoldTechnologyCommerceUganda/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window, QWidget *parent) :
