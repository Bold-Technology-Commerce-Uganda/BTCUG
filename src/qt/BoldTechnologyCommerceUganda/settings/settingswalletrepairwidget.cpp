...
#include "qt/BoldTechnologyCommerceUganda/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/BoldTechnologyCommerceUganda/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BOLDTECHNOLOGYCOMMERCEUGANDAGUI::handleRestart()
