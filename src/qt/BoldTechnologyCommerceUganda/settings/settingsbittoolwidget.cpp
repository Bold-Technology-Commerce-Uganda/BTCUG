...
#include "qt/BoldTechnologyCommerceUganda/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window, QWidget *parent) :
