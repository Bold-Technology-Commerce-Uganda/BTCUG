...
#include "qt/BoldTechnologyCommerceUganda/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window, QWidget *parent) :
