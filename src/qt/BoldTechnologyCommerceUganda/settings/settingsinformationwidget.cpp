...
#include "qt/BoldTechnologyCommerceUganda/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window,QWidget *parent) :
