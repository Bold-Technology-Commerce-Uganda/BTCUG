...
#include "qt/BoldTechnologyCommerceUganda/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/BoldTechnologyCommerceUganda/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &BOLDTECHNOLOGYCOMMERCEUGANDAGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
