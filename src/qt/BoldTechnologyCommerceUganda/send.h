...
#include "qt/BoldTechnologyCommerceUganda/contactsdropdown.h"
#include "qt/BoldTechnologyCommerceUganda/sendmultirow.h"
...
public:
    explicit SendWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* parent);
    ~SendWidget();
