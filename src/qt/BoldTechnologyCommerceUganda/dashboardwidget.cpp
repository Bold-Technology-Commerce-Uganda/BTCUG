...
#include "qt/BoldTechnologyCommerceUganda/forms/ui_dashboardwidget.h"
#include "qt/BoldTechnologyCommerceUganda/sendconfirmdialog.h"
#include "qt/BoldTechnologyCommerceUganda/txrow.h"
...
DashboardWidget::DashboardWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* parent) :
    PWidget(parent),
...
//    connect(ui->pushButtonAll, &QPushButton::clicked, [this](){setChartShow(ALL);});
    if (window)
        connect(window, &BOLDTECHNOLOGYCOMMERCEUGANDAGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
...
void DashboardWidget::loadWalletModel()
{
 ...
 //       connect(ui->pushImgEmpty, &QPushButton::clicked, window, &BOLDTECHNOLOGYCOMMERCEUGANDAGUI::openFAQ);
