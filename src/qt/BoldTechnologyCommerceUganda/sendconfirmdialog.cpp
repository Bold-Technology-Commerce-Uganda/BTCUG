...
#include "qt/BoldTechnologyCommerceUganda/forms/ui_sendconfirmdialog.h"
...
#define BASE_WINDOW_WIDTH 575
#define BASE_WINDOW_HEIGHT 515
#define BASE_WINDOW_MIN_WIDTH 575
#define BASE_WINDOW_MIN_HEIGHT 515
    ...
    isConfirmDialog(_isConfirmDialog)
{
    ...
    this->setFixedSize(QSize(BASE_WINDOW_WIDTH, BASE_WINDOW_HEIGHT));
