...
#include <QWidget>
#include <QString>
#include "qt/BoldTechnologyCommerceUganda/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    BOLDTECHNOLOGYCOMMERCEUGANDAGUI* getWindow() { return this->window; }
...
protected:
    BOLDTECHNOLOGYCOMMERCEUGANDAGUI* window = nullptr;
