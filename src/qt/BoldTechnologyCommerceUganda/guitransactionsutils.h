...
#ifndef FURSZY_BOLDTECHNOLOGYCOMMERCEUGANDA_GUITRANSACTIONSUTILS_H
#define FURSZY_BOLDTECHNOLOGYCOMMERCEUGANDA_GUITRANSACTIONSUTILS_H
...
#endif //FURSZY_BOLDTECHNOLOGYCOMMERCEUGANDA_GUITRANSACTIONSUTILS_H
