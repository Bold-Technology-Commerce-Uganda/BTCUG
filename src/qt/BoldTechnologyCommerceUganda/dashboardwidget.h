...
#include "qt/BoldTechnologyCommerceUganda/furabstractlistitemdelegate.h"
#include "qt/BoldTechnologyCommerceUganda/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/BoldTechnologyCommerceUganda/txviewholder.h"
...
#include "config/BoldTechnologyCommerceUganda-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(BOLDTECHNOLOGYCOMMERCEUGANDAGUI* _window);
    ~DashboardWidget();
