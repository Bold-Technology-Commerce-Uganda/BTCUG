...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, BOLDTECHNOLOGYCOMMERCEUGANDAGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, BOLDTECHNOLOGYCOMMERCEUGANDAGUI* gui, double posX = 3);
