...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BoldTechnologyCommerceUganda BoldTechnologyCommerceUganda-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  BoldTechnologyCommerceUganda-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BoldTechnologyCommerceUganda transaction") + "\n" +
                               "  BoldTechnologyCommerceUganda-tx [options] -create [commands]   " + _("Create hex-encoded BoldTechnologyCommerceUganda transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BoldTechnologyCommerceUganda transaction
