...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop BoldTechnologyCommerceUganda server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BoldTechnologyCommerceUganda server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BoldTechnologyCommerceUganda features */

        {"BoldTechnologyCommerceUganda", "listmasternodes", &listmasternodes, true },
        {"BoldTechnologyCommerceUganda", "getmasternodecount", &getmasternodecount, true },
        {"BoldTechnologyCommerceUganda", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"BoldTechnologyCommerceUganda", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"BoldTechnologyCommerceUganda", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"BoldTechnologyCommerceUganda", "masternodecurrent", &masternodecurrent, true },
        {"BoldTechnologyCommerceUganda", "startmasternode", &startmasternode, true },
        {"BoldTechnologyCommerceUganda", "createmasternodekey", &createmasternodekey, true },
        {"BoldTechnologyCommerceUganda", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"BoldTechnologyCommerceUganda", "listmasternodeconf", &listmasternodeconf, true },
        {"BoldTechnologyCommerceUganda", "getmasternodestatus", &getmasternodestatus, true },
        {"BoldTechnologyCommerceUganda", "getmasternodewinners", &getmasternodewinners, true },
        {"BoldTechnologyCommerceUganda", "getmasternodescores", &getmasternodescores, true },
        {"BoldTechnologyCommerceUganda", "mnsync", &mnsync, true },
        {"BoldTechnologyCommerceUganda", "spork", &spork, true },
...
{
    return "> BoldTechnologyCommerceUganda-cli " + methodname + " " + args + "\n";
}
