...
#ifndef BOLDTECHNOLOGYCOMMERCEUGANDA_CONSENSUS_UPGRADES_H
#define BOLDTECHNOLOGYCOMMERCEUGANDA_CONSENSUS_UPGRADES_H
...
#endif // BOLDTECHNOLOGYCOMMERCEUGANDA_CONSENSUS_UPGRADES_H
