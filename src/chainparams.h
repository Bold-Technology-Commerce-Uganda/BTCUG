...
#define __PORT_MAINNET__ 10033
#define __PORT_TESTNET__ 20033
#define __PORT_REGTEST__ 30033
 ...
 * BoldTechnologyCommerceUganda system. There are three: the main network on which people trade goods
